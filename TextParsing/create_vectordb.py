...
#
# ✅ 환경변수 override 지원:
#   USE_CSV_METADATA=true|false
#   REBUILD_DB=true|false
#   COLLECTION_NAME=...
#   EMBED_MODEL=...
#   FINAL_DOCS_DIR=...
#   CSV_FILE_PATH=...
...
# ✅ 기본 경로 (환경변수로 override 가능)
FINAL_DOCS_DIR = os.path.join(PROJECT_ROOT, "final_docs")
CSV_FILE_PATH  = os.path.join(PROJECT_ROOT, "data", "data_list.csv")
DB_PATH        = os.path.join(PROJECT_ROOT, "data", "chroma_db")

# ✅ 동작 옵션 (환경변수로 override 가능)
USE_CSV_METADATA = os.getenv("USE_CSV_METADATA", "true").lower() == "true"
REBUILD_DB       = os.getenv("REBUILD_DB", "true").lower() == "true"

COLLECTION_NAME  = os.getenv("COLLECTION_NAME", "bid_rfp_collection")
EMBED_MODEL      = os.getenv("EMBED_MODEL", "text-embedding-3-small")

# ✅ 경로 override
FINAL_DOCS_DIR = os.getenv("FINAL_DOCS_DIR", FINAL_DOCS_DIR)
CSV_FILE_PATH  = os.getenv("CSV_FILE_PATH", CSV_FILE_PATH)
...
print(f"[INFO] REBUILD_DB       = {REBUILD_DB}")
